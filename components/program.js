...
export default function Program() {
  return (
    <section className="w-full min-h-[80vh] flex flex-col justify-center items-center background-sun-flipped md:background-sun-flipped-fixed drop-shadow-2xl py-16 lg:py-0 z-10">
      <Content>
