...
export default function Welcome() {
  ...
  return (
    <section id="welcome" className="w-full min-h-[90vh] flex flex-col justify-center items-center background-sun md:background-sun-fixed drop-shadow-2xl py-10 lg:py-0 z-10">
      <Content>
